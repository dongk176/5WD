      ...
      <main className="mx-auto w-full max-w-7xl px-6 pt-28 pb-16">
        <div className="mb-24 grid grid-cols-1 items-start gap-16 lg:grid-cols-2">
          <div className="order-2 lg:order-1">
            <h1 className="mb-8 text-5xl font-black leading-tight tracking-tighter text-charcoal md:text-7xl">5WD 오륜구동</h1>
            <div className="mb-8 max-w-2xl space-y-5 text-lg leading-9 font-medium text-slate-700 md:text-xl md:leading-10">
              <p>
        ...
        <section className="py-24">
          <div className="mb-12 flex items-end justify-between">
            <h3 className="text-4xl font-bold tracking-tight text-charcoal">Personnel</h3>
          </div>
